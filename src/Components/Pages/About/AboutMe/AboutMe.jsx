    ...
    return (
        <div className='about-me-wrapper'>
            ...
            <div className="about-me-content">
                <IntoViewEffect effect='slide-in-bottom' margin={50}>
                ...
                <p className='about-me-content-text'>
                    <IntoViewEffect effect='fade-in' margin={20} delay={.1} threshold={.3}>
                    ...
                    <IntoViewEffect effect='fade-in' margin={10} delay={.5} threshold={.3}>
